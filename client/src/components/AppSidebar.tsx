...
const AppSidebar = () => {
  ...
  const navLinks = {
    student: [
      ...
      { icon: FlaskConical, label: "Laboratory", href: "/user/laboratory" },
      { icon: Palette, label: "Studio", href: "/user/studio" }, // Add Studio link
    ...
    teacher: [
      ...
      { icon: FlaskConical, label: "Laboratory", href: "/teacher/laboratory" },
      { icon: Palette, label: "Studio", href: "/teacher/studio" }, // Add Studio link
            ...
            >
              <div className="app-sidebar__logo-container group">
                <div className="app-sidebar__logo-wrapper">
                  ...
                  />
                  <p className="app-sidebar__title">VEE_NOUGHT</p>
                </div>
